...
CREATE TABLE Posts ( post_id int AUTO_INCREMENT, picture_uri varchar(255) NOT NULL, body varchar(255) NOT NULL, available_date DATETIME NOT NULL, user_id int NOT NULL, PRIMARY KEY (post_id), FOREIGN KEY (user_id) REFERENCES Users(user_id) )

CREATE TABLE Ratings ( rating_id int AUTO_INCREMENT, rating varchar(255) NOT NULL, post_id int NOT NULL, PRIMARY KEY (rating_id), FOREIGN KEY (post_id) REFERENCES Posts(post_id) )
